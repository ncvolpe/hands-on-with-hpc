...
```bash
[UCID@login01 ~]$ cd /ccs/home/userid
[UCID@login01 ~]$ pwd
/ccs/home/userid
```
>> ---
...
```bash
[UCID@login01 ~]$ git clone https://github.com/olcf/hands-on-with-frontier/
...
```bash
[UCID@login01 ~]$ cd ~/hands-on-with-frontier/challenges/Basic_Unix_Vim
```
...
```bash
[UCID@login01 Basic_Unix_Vim]$ cd /ccs/home/userid
[UCID@login01 ~]$ pwd
/ccs/home/userid
```
...
```bash
[UCID@login01 Basic_Unix_Vim]$ mkdir mydirectory 
[UCID@login01 Basic_Unix_Vim]$ ls
...
```bash
[UCID@login01 Basic_Unix_Vim]$ cp test_file.txt mydirectory
```
...
```bash
[UCID@login01 Basic_Unix_Vim]$ ls mydirectory
text_file.txt
```
...
```bash
[UCID@login01 Basic_Unix_Vim]$ vim text_file.txt
```
